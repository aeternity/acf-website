...
export function PersonCard(person: Person) {
  const src = person.imageSrc
    ...
    : "https://via.placeholder.com/252x252";

  return (
    <div className="team-member">
      <div className="clear-both">
        <div
          className={`team-member-img overflow-hidden w-[100%] h-[310px]  lg:h-[252px]  bg-no-repeat bg-cover bg-center`}
          style={{
            backgroundImage: "url('" + src + "');",
          }}
        ></div>
        <div className="team-member-wrap clear-both">
          <h3 className="team-member-title">{person.name}</h3>
          <div className="team-member-info">Vice President</div>
